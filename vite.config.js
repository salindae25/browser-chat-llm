...
export default defineConfig({
	...
	build: {
		rollupOptions: {
			output: {
				manualChunks: {
					ai_sdk: ['@ai-sdk/google', '@ai-sdk/openai', '@ai-sdk/openai-compatible', '@ai-sdk/groq'],
					react: ['react', 'react-dom', '@ai-sdk/react',],
					markdown:[ 'react-markdown'],
					syntax_highlighter:[ 'react-syntax-highlighter'],
					vendor: ['@radix-ui/react-avatar', '@radix-ui/react-collapsible', '@radix-ui/react-dialog',
						...
						'lucide-react', 'sonner', 'date-fns', 'dexie']
				}
			}
		}
	},
